...
import { loginController, registerController, signoutController, changePasswordController, checkPasswordController, changePasswordValidTicketController, generateChangePasswordTicketController } from "@/controllers/auth.controller";
